...
urlpatterns = [
    ...
    path('oura/daily_activity_row_for_day/', oura_daily_activity_row_for_day, name='oura-daily-activity-row-for-day'),
    path('oura/daily_sleep_row_for_day/', oura_daily_sleep_row_for_day, name='oura-daily-sleep-row-for-day'),
    path('oura/daily_readiness_row_for_day/', oura_daily_readiness_row_for_day, name='oura-daily-readiness-row-for-day'),
